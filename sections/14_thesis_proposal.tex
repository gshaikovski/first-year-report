...
Chapter~\ref{ch:progress_report} shows suboptimal and invalid search traces underperform in the search-efficient regime, yet unrelated traces do not collapse into solution-only learning.
...
We formalise this as search-efficient and search-optional learning regimes, and provide evidence that they is determined by the problem structure: changing the problem from maze navigation to Countdown switches learning from search-optional to search-efficient regime.
